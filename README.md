...
3. Create `src/main/resources/application.properties` with your own credentials. This file is intentionally gitignored, so it is not included in the repository:
...
Once the application is running, interactive Swagger/OpenAPI documentation is available at:
...
GitHub: [github.com/UshaM22](https://github.com/UshaM22)